<section class="row">
    <div class="col starts-at-full ends-at-two-thirds clr holding-box">
        <div class="breather">
                ...
                <section class="order-option-main breather">
                    ...
                    <div class="order-buttons">
                        ...
                        <ul>
                            ...
                            <a href="/details/addtobasket/D7087199" class="discoveryPrimaryCallToActionLink" data-webtrends-call="addToBasket">Add to basket</a>
                        </ul>
            ...
            <table class="asset-details">
                ...
                <tbody>
                <tr><th scope="row">Reference:</th><td>ADM 188/1107/101701 </td></tr>
            ...
            <div id="hierarchy">
                ...
                <ul>
                    ...
                    <li class="tree">
                        <a href="/browse/r/h/D7087199">ADM 188/1107/101701 - Name   Riddell, David     Official Number:   SS101701     Place of Birth:   Liverpool,...</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="col starts-at-full ends-at-one-third clr holding-box">
                ...
                <div class="add-tag ">
                    <ul id="add-tag-list" style="display:none;">
                        <li>
                            ...
                            <div class="tagForm">
                                <form action="/Details/AddTag?iaid=D7087199" method="post" novalidate="novalidate">                        <label for="tagEntryText" class="entryLabel">Enter tag:</label>
        ...
        <form action="/details/r/D7087199/submitcorrection" id="suggest-a-correction-form" method="post" novalidate="novalidate">    <h2><span><span>Found an error?</span></span></h2>
            <div class="breather">
