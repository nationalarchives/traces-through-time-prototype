...
<section class="row">
    <div class="col starts-at-full ends-at-two-thirds clr holding-box">
        <div class="breather">
            <h1 class="inline">Name <?php echo $name; ?> Official Number: SS101701 Place of Birth: Liverpool,...</h1>
                ...
                <section class="order-option-main breather">
                    ...
                    <div class="order-buttons">
                        ...
                        <ul>
                            ...
                            <a href="/details/addtobasket/D7087199" class="discoveryPrimaryCallToActionLink"
            ...
            <table class="asset-details">
                <caption>Details of ADM 188/1107/101701</caption>
                <tbody>
                <tr>
                    <th scope="row">Reference:</th>
                    <td>ADM 188/1107/101701</td>
                </tr>
                    ...
                    <td id="annotationcontentdescription">
                        <table>
                            ...
                            <tr class="medalRow">
                                ...
                                <td class="medalplain">SS101701</td>
                            </tr>
                            <tr class="medalRow">
                                <td class="medalheader"> Place of Birth:</td>
                                <td class="medalplain">Liverpool, Lancashire</td>
                            </tr>
                            <tr class="medalRow">
                                <td class="medalheader"> Date of Birth:</td>
                                <td class="medalplain">28 May 1887</td>
                            </tr>
                            </tbody>
                        </table>
                    </td>
            ...
            <div id="hierarchy">
                ...
                <a class="browseByReference" href="/browse/r/r/D7087199">Browse by Reference</a>
                <ul>
                    ...
                    <li class="tree">
                        <a href="/browse/r/h/C4463109">ADM 188/1107 - 101001-102000</a>
                    </li>
                    <li class="tree">
                        <a href="/browse/r/h/D7087199">ADM 188/1107/101701 - Name Riddell, David Official Number:
                            SS101701 Place of Birth: Liverpool,...</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="col starts-at-full ends-at-one-third clr holding-box">
                ...
                <div class="add-tag ">
                    <ul id="add-tag-list" style="display:none;">
                        <li>
                            ...
                            <div class="tagForm">
                                <form action="/Details/AddTag?iaid=D7087199" method="post" novalidate="novalidate">
                    ...
                    <ul id="sign-in-or-register" style="">
                        <li>
                            <p>
                                ...
                                <a href="/register?returnUrl=%2Fdetails%2Fr%2FD7087199">register</a>.
                            </p>
                        </li>
                    </ul>
        ...
        <form action="/details/r/D7087199/submitcorrection" id="suggest-a-correction-form" method="post"
