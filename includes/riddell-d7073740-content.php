<section class="row">
    <div class="col starts-at-full ends-at-two-thirds clr holding-box">
        <div class="breather">
                ...
                <section class="order-option-main breather">
                    ...
                    <div class="order-buttons">
                        ...
                        <ul>
                            ...
                            <a href="/details/addtobasket/D7073740" class="discoveryPrimaryCallToActionLink" data-webtrends-call="addToBasket">Add to basket</a>
                        </ul>
            ...
            <div class="viewer-message">
                ...
                <p>This record is available to view with our image viewer. <a id="imageViewerLink" href="#imageViewerLink" role="button">Show images</a></p>
            </div>
            ...
            <table class="asset-details">
                ...
                <tbody>
                <tr><th scope="row">Reference:</th><td>ADM 188/1114/108003 </td></tr>
            ...
            <div id="hierarchy">
                ...
                <ul>
                    ...
                    <li class="tree">
                        <a href="/browse/r/h/C4">ADM - Records of the Admiralty, Naval Forces, Royal Marines, Coastguard, and related bodies</a>
                    </li>
                    <li class="tree">
                    ...
                    <li class="tree">
                        <a href="/browse/r/h/D7073740">ADM 188/1114/108003 - Name   Riddell, David     Official Number:   SS108003     Place of Birth:   Coalbridge,...</a>
                    </li>
                </ul>
            </div>
            ...
            <div id="sharing-btns">
                <div class="addthis_toolbox addthis_default_style addthis_32x32_style">
                    <a class="addthis_button_facebook at300b" title="Facebook" href="#"><span class="at4-icon aticon-facebook" style="background-color: rgb(48, 88, 145);"><span class="at_a11y">Share on facebook</span></span></a><a class="addthis_button_twitter at300b" title="Tweet" href="#"><span class="at4-icon aticon-twitter" style="background-color: rgb(44, 168, 210);"><span class="at_a11y">Share on twitter</span></span></a><a class="addthis_button_email at300b" target="_blank" title="Email" href="#"><span class="at4-icon aticon-email" style="background-color: rgb(115, 138, 141);"><span class="at_a11y">Share on email</span></span></a><a class="addthis_button_compact at300m" href="#"><span class="at4-icon aticon-compact" style="background-color: rgb(252, 109, 76);"><span class="at_a11y">More Sharing Services</span></span></a>
                    <div class="atclear"></div></div>
                <p>Sharing will require cookies. <a title="Cookie policy" href="http://www.nationalarchives.gov.uk/legal/cookies.htm">Show details</a></p>
    ...
    <div class="col starts-at-full ends-at-one-third clr holding-box">
                ...
                <div class="add-tag ">
                    <ul id="add-tag-list" style="display:none;">
                        <li>
                            ...
                            <div class="tagForm">
                                <form action="/Details/AddTag?iaid=D7073740" method="post" novalidate="novalidate">                        <label for="tagEntryText" class="entryLabel">Enter tag:</label>
        ...
        <form action="/details/r/D7073740/submitcorrection" id="suggest-a-correction-form" method="post" novalidate="novalidate">    <h2><span><span>Found an error?</span></span></h2>
            <div class="breather">
